...
> 둘 이상의 상이한 운송수단에 의해 물품을 운송하기위해, 단일계약으로 이루어지는 운송을 말한다.
>
...
> general average (공동해손) : 보험 목적물이 안전을 위해 희생되었을때 이해관계자들이 공동으로 손해액을 담당하는것이다. 그 예로 안전상 위협이 생겼을때 선장의 판단에 따라 화물을 바다에 던지는 jettision(투하)가 있다.
>
